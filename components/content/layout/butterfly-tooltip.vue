<!-- /components/content/layout/butterfly-tooltip.vue -->
<template>
    ...
    >
      <div>
        <span class="font-semibold">
          ...
          AMI Says:
          <span class="text-default text-xl">{{ tooltip }}</span>
        </span>
      </div>
    </div>
  </div>
...
const { tooltip } = storeToRefs(usePageStore())
