...
<template>
  ...
  >
    ...
    <div class="relative w-full h-full">
      ...
      <!-- Reactions Toggle -->
      <button
        class="absolute top-4 right-4 btn btn-sm btn-accent btn-circle z-50"
      ...
      <!-- Back Button -->
      <button
        class="absolute bottom-4 left-4 btn btn-sm btn-outline btn-primary shadow-md z-50"
        @click="handleBack"
      >
