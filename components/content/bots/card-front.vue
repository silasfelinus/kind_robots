...
<template>
  <div
    class="card-front grid grid-rows-4 gap-4 p-4 border-2 border-solid border-gray-300 bg-base-300 opacity-90 rounded-lg shadow-lg text-base-content items-start h-auto lg:h-screen my-4"
  >
    <div
      v-if="currentBot"
