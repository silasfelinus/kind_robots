<!-- components/scenarios/scenario-hand.vue -->
<template>
  <div
    class="flex items-center gap-2 overflow-x-auto px-4 py-2.5 scrollbar-thin"
  >
    <button
      v-for="card in builder.visibleCards"
      :key="card.key"
      type="button"
