...
export const sampleIdeas: Idea[] = [
  ...
  { title: `Failed Reality TV Shows`, example: `Extreme Ironing: The Ultimate Wrinkle Challenge` },
  ...
  { title: `Terrible Tourist Attractions`, example: `The Museum of Unfinished Paintings` },
  { title: `Unusual Cooking Shows`, example: `Cooking with Cardboard: A Recycling Adventure` },
  { title: `Awkward Superpowers`, example: `The ability to turn wine back into water` },
  { title: `Unlikely Pet Tricks`, example: `Teaching your goldfish to fetch` },
  { title: `Absurd Dating Apps`, example: `Tinder for Tacos: Find your perfect crunch` },
  { title: `Unconventional Theme Parks`, example: `Introvert Island: No Rides, Just Books` },
  { title: `Unfortunate Children’s Book Titles`, example: `Where’s Waldo: Quarantine Edition` },
  ...
  { title: `Unlikely Celebrity Endorsements`, example: `Stephen Hawking for Skateboards` },
