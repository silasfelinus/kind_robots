...
4. ✅ Bot, Project, Server, Theme, and PitchSheet response/create-boundary cleanup; retired the unused SocialPost/SocialTarget prototype instead of preserving dead CRUD.
