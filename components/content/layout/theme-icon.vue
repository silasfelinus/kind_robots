<template>
  ...
  >
    ...
    <Icon
      ...
      class="h-8 w-8 md:w-10 md:h-10 lg:w-12 lg:h-12 xl:w-14 xl:h-14 transition-transform transform hover:scale-110 duration-300 ease-in-out text-accent"
    />

    <!-- Theme Name (Visible on md and higher) -->
    <span class="hidden md:block text-sm transition-colors">
      {{ currentTheme }}
    </span>

    <!-- Popup for sm screens -->
    <div
