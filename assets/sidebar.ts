export const sidebarLinks = [
  ...
  { title: 'Pitch Manager', path: '/pitch', icon: 'fluent:chat-bubbles-question-16-regular' },
  ...
  { title: 'Brainstorm', path: '/brainstorm', icon: 'game-icons:robot-antennas' },
  { title: 'Memory Match', path: '/memory', icon: 'material-symbols:art-track-outline-rounded' },
  ...
  { title: 'Wonderlab', path: '/wonderlab', icon: 'game-icons:gear-hammer', condition: 'showMature' },
