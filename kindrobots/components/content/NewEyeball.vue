...
const handleClick = (event) => {
  ...
  moveIris(event)
  eyeElement.value.addEventListener('mousemove', moveIris)

  trackTimeout = setTimeout(() => {
    eyeElement.value.removeEventListener('mousemove', moveIris)
...
onBeforeUnmount(() => {
  ...
  eyeElement.value && eyeElement.value.removeEventListener('mousemove', moveIris)
})
</script>
