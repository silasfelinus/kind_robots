<template>
  <div class="bg-base-300 rounded-2xl p-4">
    ...
    <div class="flex flex-col lg:flex-row lg:space-x-6 items-center lg:items-start">
      <!-- Avatar Section -->
      <div class="flex flex-col items-center w-full lg:w-1/3">
        <user-avatar class="w-24 h-auto max-h-1/3 rounded-full border-2 border-accent mb-4" />
        <avatar-upload class="w-16 h-16 mt-2" />
        <h2 class="text-lg font-semibold bg-base-300 border-accent rounded-2xl border p-2 mt-4">
