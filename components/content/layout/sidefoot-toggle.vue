<template>
  <div class="relative">
    <button
      class="w-16 h-16 rounded-tl-2xl shadow-lg bg-gradient-to-tl from-accent to-accent-dark hover:bg-secondary border-b-4 border-l-4 text-2xl font-semibold text-white flex items-center justify-center transition-transform duration-300 ease-in-out absolute bottom-0 left-0"
      @click="toggleState"
    >
