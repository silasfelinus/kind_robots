<template>
  <div class="relative h-full flex flex-col">
    ...
    <div class="relative flex-grow h-full flex flex-col">
      ...
      <fullscreen-toggle
        class="absolute top-2 left-1/2 transform -translate-x-1/2 w-5 h-5 z-20 p-2 text-accent cursor-pointer"
      />

      <!-- Left Toggle Button (inside content) -->
      <left-toggle
        class="absolute left-2 top-1/2 w-5 h-5 transform -translate-y-1/2 z-20 p-2 text-accent rounded-l-lg cursor-pointer"
      />
      
      <!-- Right Sidebar Toggle (inside content) -->
      <right-toggle
        class="absolute right-2 top-1/2 w-5 h-5 transform -translate-y-1/2 z-20 p-2 text-accent rounded-l-lg cursor-pointer"
      ...
      <!-- Footer Toggle (inside content) -->
      <footer-toggle
        class="absolute bottom-2 left-1/2 transform -translate-x-1/2 w-5 h-5 z-20 p-2 text-accent cursor-pointer"
      />
    </div>
  </div>
</template>
