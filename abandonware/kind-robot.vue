<!-- /components/content/bots/kind-robot.vue -->
<template>
  ...
  >
    ...
    <div
      ...
      class="w-full bg-base-300 rounded-2xl flex flex-col grow overflow-hidden"
    >
      ...
      <div class="flex flex-col md:flex-row w-full grow overflow-hidden">
        <!-- Bot Avatar and Carousel on left -->
        <div class="w-full md:w-1/3 p-2 shrink-0 max-h-full">
        ...
        >
          <!-- Bot Details -->
          <div class="text-center mb-2 grow overflow-y-auto">
