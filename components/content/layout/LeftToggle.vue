<template>
  <div class="relative">
    <button
      class="w-5 h-5 rounded-tl-2xl border-l-4 border-t-4 shadow-lg bg-gradient-to-br from-accent to-accent-dark hover:bg-secondary transition-all duration-300 ease-in-out text-2xl font-semibold text-white flex items-center justify-center"
