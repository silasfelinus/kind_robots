<template>
  ...
  >
    <header
      class="flex shrink-0 flex-wrap items-center gap-2 rounded-xl border border-base-300 bg-base-100 px-3 py-2"
    >
      <Icon name="kind-icon:gearhammer" class="size-4 text-primary" />
      <strong>Projects</strong>
      <span class="badge badge-primary badge-sm"
        >{{ allItems.length }} records</span
      >
      <span
    ...
    <nav
      class="flex shrink-0 flex-wrap gap-1 rounded-xl border border-base-300 bg-base-100 p-2"
    >
      <button
