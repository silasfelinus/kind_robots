...
const fixtures: Record<string, WonderLabPreviewFixture> = {
  'brainstorm-candidate-card': {
    ...
    description:
      'A synthetic branched candidate exercises curation, revision history, and lineage without generation, persistence, or database dependencies.',
    viewport: 'tablet',
    minHeight: '28rem',
    props: {
      candidate: {
        ...
        text: 'A tiny public library checks out jars of weather for one afternoon at a time, then sends increasingly specific overdue notices when the thunder comes back late.',
        status: 'pending',
        feedback: '',
        edited: true,
        parentId: 'candidate-wonderlab-parent',
        revisions: [
          {
            title: 'Borrowed Weather',
            text: 'A public library lends jars of weather to neighborhood patrons.',
            createdAt: '2026-08-10T00:00:00.000Z',
            reason: 'branched',
            returnType: 'left-field',
          },
          {
            title: 'The Library of Borrowed Weather',
        ...
        meta: {
          returnType: 'left-field',
          branchOrigin: {
            candidateId: 'candidate-wonderlab-parent',
            revisionIndex: 1,
            title: 'Weather Library Prototype',
            text: 'A library lends jars of rain and sunshine with ordinary due dates.',
          },
        },
      },
      disabled: false,
