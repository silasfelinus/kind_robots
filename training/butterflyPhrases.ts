...
export const funPhrases = [
  ...
  'time to get flappin ! 💖',
  'does anyone know where the api is? 🌟',
  'Time to write some tweets! 🌼',
  'Researching malaria on wikipedia 🧁',
  'after this lets get coffee at the bot cafe',
  'what are we doing?',
  'i am so ready to hyperfocus right now',
