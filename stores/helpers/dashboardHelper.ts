    ...
    tabs: [
      {
        ...
        title: 'Dream Cockpit',
        summary: 'Build the dream flow from prompt, image, or interaction.',
      },
      {
        key: 'gallery',
        label: 'Gallery',
        icon: 'kind-icon:gallery',
        title: 'Dream Gallery',
        summary: 'Browse generated dream assets.',
      },
      {
        key: 'prompts',
        label: 'Prompts',
        ...
        title: 'Dream Prompts',
        summary: 'Manage prompts used in dream generation.',
      },
      {
        key: 'collections',
        label: 'Collections',
        ...
        summary: 'Curate related dreams, images, and story assets.',
      },
      {
        key: 'servers',
        label: 'Servers',
        icon: 'kind-icon:server',
        title: 'Server Manager',
        summary: 'Manage the engines powering dream generation.',
      },
      {
        key: 'settings',
        label: 'Settings',
        ...
        summary: 'Tune dream behavior and defaults.',
      },
    ],
  },
