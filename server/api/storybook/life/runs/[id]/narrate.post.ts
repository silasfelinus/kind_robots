// /server/api/storybook/life/runs/[id]/narrate.post.ts
//
...
// POST /api/storybook/life/runs/:id/choices as a separate step, so
// LifeChoice/LifeStat writes and all outcome math stay in
...
//
// storybook/t-026: moved here from /api/davinci/runs/[id]/narrate.post.ts.
// The old path still works -- it re-exports this handler.
...
// One narrator lookup, shared with the neutral /api/storybook/* namespace.
// It moved to storybookRuns.ts rather than davinciNarration.ts so that module
// stays free of ./prisma and importable by the DB-less contract suite.
import { loadRunNarrator } from '../../../../../utils/storybookRuns'
