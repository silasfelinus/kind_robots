<!-- /components/content/story/story-creator.vue -->
<template>
  <div
    class="mx-auto flex w-full max-w-6xl flex-col gap-6 rounded-2xl bg-base-200 p-4 md:p-6"
  >
    <header class="text-center">
      <h1 class="text-3xl font-bold text-primary md:text-4xl">Story Creator</h1>
      ...
      >
        ...
        launch a branching Weirdlandia story.
      </p>
    </header>
      ...
      <article class="rounded-2xl border border-base-300 bg-base-100 p-4">
        <div class="mb-3 flex items-center justify-between gap-2">
          <div>
            ...
            <p class="text-sm text-base-content/60">
              Choose who gets pulled into the story.
            </p>
          </div>
        ...
        <character-gallery
          ...
          variant="dropdown"
          title="Character"
          subtitle="Choose the protagonist, victim, goblin, or intern."
          :show-images="false"
          :show-controls="false"
          :show-toolbar="false"
        />
