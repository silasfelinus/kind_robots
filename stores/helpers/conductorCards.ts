...
export const CONDUCTOR_CARDS: ConductorCard[] = [
  ...
  card(
    ...
    'Humboldt Scoop',
    'kind-icon:globe',
    'Imported and modernized',
    'The existing site was imported, hardened, and rebuilt cleanly with a refreshed content brief — all planned work shipped.',
    'software',
    'done',
    2,
  ),
  ...
  card(
    ...
    'Mermaids of Venice',
    'kind-icon:mermaid',
    "Silas Knight's novel, live in the giftshop",
    "The book's landing page is live at /mermaids with a full editorial review pipeline (impressions, notes, cultural-awareness, typo list) done and awaiting Silas's read. The full mermaidsofvenice.com site stays parked until he unparks it.",
    'content',
    'needs-human',
    21,
  ),
  card(
    ...
    'Coat Dance',
    'kind-icon:dance',
    'AI remix pipeline for a dance short',
    'Turning a source dance video into a stylized short: beat-mapping the source, drafting a creative treatment, generating a style-frame pack, then remixing section-by-section into a final cut.',
    'content',
    'ready',
    22,
  ),
