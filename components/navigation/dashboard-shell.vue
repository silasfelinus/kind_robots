...
<template>
  ...
  >
    ...
    <button
      v-if="!showHeader"
      class="btn btn-xs btn-ghost absolute left-0 top- z-50 flex h-8 min-h-0 flex-col gap-0 rounded-xl border border-base-300 bg-base-100 px-2 leading-none shadow-sm"
      type="button"
      title="Show header"
      @click="toggleHeader"
    >
