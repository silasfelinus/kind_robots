...
const increaseZIndex = (slider: string) => {
  if (slider === 'min') {
    document.querySelector('.min-slider')!.style.zIndex = '4'
    document.querySelector('.max-slider')!.style.zIndex = '3'
  } else {
    document.querySelector('.max-slider')!.style.zIndex = '4'
    document.querySelector('.min-slider')!.style.zIndex = '3'
  }
}
