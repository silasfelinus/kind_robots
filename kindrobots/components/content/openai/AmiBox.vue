...
<template>
  <div class="fixed bottom-3 right-3 md:bottom-[10px] md:right-[10px]">
    <button
      v-show="!open"
      @click="open = true"
    ...
    <div
      ...
      class="box bg-gray-300 dark:bg-gray-800 rounded w-full md:w-[450px] max-w-[90vw] overflow-hidden"
    >
      <!-- Header -->
      <header
      ...
      <div class="messages p-4 overflow-y-auto max-h-[80vh]" ref="messageBox">
        <div v-if="!messages.length" class="text-center w-[350px] m-auto">
          <strong class="text-lg">Chat with AMI</strong>
          <p>The Anti Malaria Intelligence</p>
          <strong class="block mt-10">Go ahead and ask us something:</strong>
          <ul class="list-inside list-disc text-left">
            <li>What's so bad about malaria?</li>
