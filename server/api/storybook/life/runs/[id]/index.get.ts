// /server/api/storybook/life/runs/[id]/index.get.ts
//
...
//
// storybook/t-026: moved here from /api/davinci/runs/[id]/index.get.ts. The
// old path still works -- it re-exports this handler.
