...
describe('Relationship API Tests', () => {
  ...
  before(() => {
    cy.env(['API_BASE', 'ADMIN_TOKEN']).then((env) => {
  ...
  it('creates core ArtImage fixtures', () => {
      postRecord('artImage', {
        ...
        .then((artImage) => {
          ...
          expectFieldEquals(artImage, 'userId', userId)
    ...
    it('creates Resource and Server fixtures', () => {
      ...
      postRecord('server', {
        ...
        .then((server) => {
          ...
          expectFieldEquals(server, 'userId', userId)
        ...
        .then((resource) => {
          ...
          expectFieldEquals(resource, 'userId', userId)
    ...
    it('creates ArtCollection fixture', () => {
      ...
      postRecord('artCollection', {
        ...
        expectFieldEquals(collection, 'userId', userId)
    ...
    it('creates primary model fixtures with direct relations', () => {
      ...
      postRecord('bot', {
        ...
        .then((bot) => {
          ids.bot = bot.id
          expectFieldEquals(bot, 'userId', userId, 'bot')
        ...
        .then((character) => {
          ...
          expectFieldEquals(character, 'userId', userId, 'character')
          expectFieldEquals(
            character,
            'artImageId',
            id('artImageA'),
        ...
        .then((prompt) => {
          ...
          expectFieldEquals(prompt, 'userId', userId, 'prompt')
          ...
          return postRecord('reward', {
            ...
            flavorText:
              'A tiny bell rings whenever a relation include is missing.',
            collection: 'cypress',
            rarity: 'COMMON',
            rewardType: 'ITEM',
            userId: userId,
        ...
        .then((reward) => {
          ...
          expectFieldEquals(reward, 'userId', userId, 'reward')
        ...
        .then((scenario) => {
          ...
          expectFieldEquals(scenario, 'userId', userId, 'scenario')
          ...
          return postRecord('dream', {
            ...
            artPrompt:
              'cypress relationship test chamber, glowing relation graph',
            userId: userId,
            artImageId: id('artImageA'),
        ...
        .then((dream) => {
          ids.dream = dream.id
          expectFieldEquals(dream, 'userId', userId, 'dream')
    ...
    it('creates secondary model fixtures with direct relations', () => {
      ...
      postRecord('chat', {
        ...
        .then((chat) => {
          ids.chat = chat.id
          expectFieldEquals(chat, 'userId', userId)
        ...
        .then((composition) => {
          ...
          expectFieldEquals(composition, 'userId', userId)
    ...
    it('creates ownership-only fixtures', () => {
      ...
      postRecord(
        ...
        .then((record) => {
          ...
          expectFieldEquals(record, 'userId', userId)
        ...
        .then((code) => {
          ids.code = code.id
          expectFieldEquals(code, 'userId', userId)
        ...
        .then((log) => {
          ids.log = log.id
          expectFieldEquals(log, 'userId', userId)
        ...
        .then((smartIcon) => {
          ...
          expectFieldEquals(smartIcon, 'userId', userId)
        ...
        .then((theme) => {
          ids.theme = theme.id
          expectFieldEquals(theme, 'userId', userId)
        })
    })
    ...
    describe('Primary direct relationship verification', () => {
      ...
      it('verifies Bot direct relations', () => {
        ...
        getRecord('bot', id('bot'), true).then((bot) => {
          expectFieldEquals(bot, 'userId', userId)
      ...
      it('verifies Dream direct relations', () => {
        ...
        getRecord('dream', id('dream'), true).then((dream) => {
          expectFieldEquals(dream, 'userId', userId)
