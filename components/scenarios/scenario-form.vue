<!-- /components/content/weird/scenario-form.vue -->
<template>
  <div
        ...
        <div class="mb-4 flex items-center justify-between gap-2">
          <div>
            ...
            <p class="text-sm text-base-content/70">
              These become buttons players can choose from when the scenario
              starts.
            </p>
          </div>
...
const subtitle = computed(() =>
  mode.value === 'edit'
    ? 'Tune the world, sharpen the choices, and generally harass causality.'
...
onMounted(() => {
  ...
  if (!Object.keys(scenarioStore.scenarioForm || {}).length) {
    resetForAdd()
  }
})
...
async function changeToRandomImage() {
  try {
    ...
    statusTone.value = 'error'
    statusMessage.value = 'Error picking random image.'
  }
}
