export default defineEventHandler((context) => [
  ...
  },
  {
    ...
    avatarImage: `/images/seuss/Mixed_Down_mixedDown_v10-12.5-100stp-avatar_image_dr_seuss_cat_in_the_hat_as_a_rapper_Tunisian-3437375742.webp`,
    model: `gpt-3.5-turbo`,
    post: `https://api.openai.com/v1/completions`,
    temperature: 1.0,
    max_tokens: 1096,
  ...
  },
  {
    ...
    avatarImage: `/images/amibot/amibot2.webp`,
    model: `gpt-3.5-turbo`,
  ...
  },
  {
    ...
    avatarImage: `/images/amibot/amibot3.webp`,
    model: `gpt-3.5-turbo`,
  ...
  },
  {
    ...
    avatarImage: '/images/avatars/bot8.webp',
    model: `gpt-3.5-turbo`,
    post: `https://api.openai.com/v1/completions`,
    temperature: 0.6,
    max_tokens: 4096,
  ...
  },
  {
    ...
    avatarImage: `/images/avatars/bot5.webp`,
    model: `gpt-3.5-turbo`,
    post: `https://api.openai.com/v1/completions`,
    temperature: 1,
    max_tokens: 4096,
  ...
  },
  {
    ...
    avatarImage: `/images/avatars/bot9.webp`,
    model: `gpt-3.5-turbo`,
    post: `https://api.openai.com/v1/completions`,
    temperature: 0.6,
    max_tokens: 4096,
  ...
  },
  {
    ...
    avatarImage: `/images/avatars/cassandra-avatar.webp`,
    model: `gpt-3.5-turbo`,
    post: `https://api.openai.com/v1/completions`,
    temperature: 0.6,
    max_tokens: 4096,
  ...
  },
  {
    ...
    avatarImage: `/images/avatars/cassandra5.webp`,
    model: `gpt-3.5-turbo`,
    post: `https://api.openai.com/v1/completions`,
    temperature: 0.6,
    max_tokens: 4096,
  ...
  },
  {
    ...
    avatarImage: `images/avatars//bot2.webp`,
    model: `gpt-3.5-turbo`,
    post: `https://api.openai.com/v1/completions`,
    temperature: 0.6,
    max_tokens: 4096,
  ...
  },
  {
    ...
    avatarImage: `/images/avatars/bot6.webp`,
    model: `gpt-3.5-turbo`,
    post: `https://api.openai.com/v1/completions`,
    temperature: 0.6,
    max_tokens: 4096,
