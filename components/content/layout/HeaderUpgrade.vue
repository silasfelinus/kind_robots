<template>
  <div
    class="relative w-full m-1 p-1"
    :class="`max-h-[${displayStore.headerHeight}vh] max-w-100vw]`"
  >
    <header
      class="flex items-center justify-between rounded-2xl border p-1 m-1 bg-base-300 w-full max-w-[95vw] space-x-2 z-20"
