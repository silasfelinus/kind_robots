export const scenarios = [
  ...
  },
  {
    ...
    description: "A hidden door in the subway leads to an alternate version of your city teeming with magical creatures.",
    intros: JSON.stringify([
    ...
    locations: "enchanted subway tunnels, floating city square, clocktower of trapped spirits, magical marketplace of forgotten goods",
    artPrompt: "hidden subway door, urban fantasy city, supernatural creatures, glowing streets, mysterious shadows",
  },
  {
    title: "RoboRevolution",
    genres: "sci-fi, political thriller, dystopia",
    description: "Your vintage robot assistant reveals advanced AI capabilities, pulling you into a conspiracy.",
    intros: JSON.stringify([
    ...
    locations: "AI-controlled senate chambers, underground robot rebellion hideout, abandoned android factories, futuristic urban wastelands",
    artPrompt: "futuristic city, humanoid robots, tense political atmosphere, neon-lit environments, ethical dilemmas",
  },
  {
    title: "Wanderlust Wonders",
    genres: "exploration, adventure, mystery",
    description: "A mysterious letter invites you to join an elite group of portal-hopping explorers.",
    intros: JSON.stringify([
    ...
    locations: "hidden desert oases, jungle ruins with glowing hieroglyphs, arctic caves of eternal crystals, cloud palaces of unknown kings",
    artPrompt: "hidden portals, adventurous landscapes, mysterious letters, ancient ruins, fantastical worlds",
  },
  {
    title: "Graveyard Shift",
    genres: "supernatural thriller, horror, mystery",
    description: "Your night job at a cemetery reveals the restless dead aren’t content with staying buried.",
    intros: JSON.stringify([
    ...
    locations: "abandoned mausoleum, shadowed grave digger’s quarters, cursed crypts, spectral chapel of whispers",
    artPrompt: "haunted cemetery, restless spirits, eerie gravestones, moonlit fog, dark supernatural vibes",
  },
  {
    title: "Lunar Legacy",
    genres: "sci-fi, exploration, mystery",
    description: "The moon holds ancient alien ruins, and you’ve been chosen to uncover its secrets.",
    intros: JSON.stringify([
    ...
    locations: "crystalline alien temples, moon caves with glowing carvings, ruins under lunar craters, alien observatories pointed at Earth",
    artPrompt: "alien ruins, glowing lunar surface, futuristic exploration suits, ancient carvings, mysterious atmosphere",
  },
  {
    title: "Clockwork Symphony",
    genres: "steampunk, musical, adventure",
    description: "A mechanical orchestra runs amok in a Victorian city, and only you can restore harmony.",
    intros: JSON.stringify([
    ...
    locations: "steampunk music hall, clocktower control room, underground mechanical orchestra workshop, gaslit Victorian streets",
    artPrompt: "mechanical orchestra, steampunk Victorian city, chaotic clockwork instruments, glowing gears, musical adventure",
  },
  {
    title: "The Spire’s Secret",
    genres: "fantasy, mystery, exploration",
    description: "A mysterious tower appears overnight, holding the key to a forgotten age.",
    intros: JSON.stringify([
    ...
    locations: "tower’s endless spiral staircases, chamber of shifting walls, floating library of enchanted scrolls, garden of eternal twilight",
    artPrompt: "mysterious spire, ancient magic, glowing runes, surreal architecture, adventurous fantasy",
  },
  {
    title: "Starlight Circus",
    genres: "space opera, spectacle, mystery",
    description: "A traveling circus among the stars reveals hidden truths about its performers—and yourself.",
    intros: JSON.stringify([
    ...
    locations: "galactic circus tent, starlit trapeze platform, alien carnival midway, hidden backstage quarters of performers",
    artPrompt: "cosmic circus, alien performers, glowing trapeze acts, mysterious galactic carnival, surreal starry landscapes",
  },
  {
    title: "Chimera Chronicles",
    genres: "biopunk, adventure, mystery",
    description: "A rogue genetic lab has created hybrid creatures you must capture—or befriend.",
    intros: JSON.stringify([
    ...
    locations: "jungle of escaped chimeras, abandoned genetic lab, hidden sanctuary of hybrid creatures, mountain pass of frozen experiments",
    artPrompt: "hybrid creatures, biopunk jungle, glowing lab equipment, mysterious genetics, adventurous exploration",
  },
  {
    title: "Whispering Woods",
    genres: "eco-fantasy, mystery, supernatural",
    description: "A cursed forest hides ancient secrets that only the bravest can uncover.",
    intros: JSON.stringify([
    ...
    locations: "glowing mushroom groves, shadowed glades of forgotten gods, labyrinth of ancient tree roots, spectral meadow of fireflies",
    artPrompt: "cursed forest, glowing mushrooms, ancient trees, eerie whispers, magical atmosphere",
  },
