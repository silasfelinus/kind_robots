...
},
{
  ...
  artImageId: null,
    ...
    inspirations: 'Grimtooth Traps, Tunnels and Trolls, Dungeons and Dragons, SmashTV, Borderlands',
...
One thing’s certain: Luxoria loves her games, and your suffering? Just part of the entertainment.`,
  ...
  inspirations: 'Who Framed Roger Rabbit, Paranoia, Looney Tunes, Coraline, Cuphead',
...
},
{
  ...
  inspirations: 'Cyberpunk 2077, Alice Through the Mirror Shades, Brazil, Wizard of Oz, Blade Runner',
...
},
  {
    ...
    inspirations: 'Deadwood, Red Dead Redemption, American Gods, Deadlands, The Dark Tower, Fables',
  ...
  inspirations: 'Doctor Who, The Time Machine, Steins;Gate, Bioshock Infinite, Loki',
  ...
  inspirations: '20,000 Leagues Under the Sea, Subnautica, H.P. Lovecraft, The Abyss',
  ...
  inspirations: 'The Hitchhiker’s Guide to the Galaxy, Rick and Morty, Adventure Time, Doctor Who, Red Dwarf',
  ...
  inspirations: 'The Wind in the Willows, Redwall, Agatha Christie, Fantastic Mr. Fox',
  ...
  inspirations: 'Studio Ghibli, The Secret Garden, Over the Hedge, Alice in Wonderland',
...
},
 {
  ...
  inspirations: 'The Matrix, Black Mirror, Ghost in the Shell, Blade Runner 2049',
...
},
{
  ...
  inspirations: 'Indiana Jones, National Treasure, Assassin’s Creed, The Name of the Rose',
...
},
 {
  ...
  inspirations: 'Neverwhere by Neil Gaiman, Dark City, The Matrix, The Night Circus',
  ...
  inspirations: 'Nier: Automata, Blade Runner, Alice in Wonderland, Westworld, The Matrix',
...
},
{
  ...
  inspirations: 'Journey, Uncharted, The Mysterious Island, The Chronicles of Narnia, Indiana Jones',
  ...
  inspirations: 'The Haunting of Hill House, Silent Hill, Crimson Peak, Night in the Woods',
  ...
  inspirations: 'The City of Lost Children, Sweeney Todd, Dishonored, The Phantom of the Opera',
  ...
  inspirations: 'Tower of Babel, Dark Souls, Myst, The Name of the Wind, Hollow Knight',
  ...
  inspirations: 'Cirque du Soleil, The Prestige, Night Circus, Mass Effect, Bioshock Infinite',
...
},
{
  ...
  inspirations: 'Jurassic Park, The Island of Dr. Moreau, Horizon Zero Dawn, Annihilation',
  ...
  inspirations: 'Pan’s Labyrinth, The Witch, Princess Mononoke, The Overstory',
