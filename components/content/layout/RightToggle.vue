<template>
  <div class="relative">
    ...
    <button
      class="w-5 h-5 rounded-tr-2xl rounded-bl-full shadow-lg bg-gradient-to-bl from-accent to-accent-dark hover:bg-secondary border-b-4 border-l-4 text-2xl font-semibold text-white flex items-center justify-center transition-transform duration-300 ease-in-out"
