  ...
  actions: {
    async initializeChannels() {
      if (!this.isInitialized) {
        ...
        try {
          ...
          errorStore.setError(ErrorType.UNKNOWN_ERROR, 'Error initializing channels');
          console.error('Error initializing channels:', errorStore.getErrors().slice(-1)[0]?.message);
        }
      }
    },
    ...
    async createOrUpdateChannel(channel: Partial<Channel>) {
      ...
      try {
        ...
        errorStore.setError(ErrorType.UNKNOWN_ERROR, 'Error creating or updating channel');
        console.error('Error creating or updating channel:', errorStore.getErrors().slice(-1)[0]?.message);
      }
    },
    ...
    async fetchCurrentChannelWithMessages(channelId: number) {
      ...
      try {
        ...
        errorStore.setError(ErrorType.UNKNOWN_ERROR, 'Error fetching current channel with messages');
        console.error('Error fetching current channel with messages:', errorStore.getErrors().slice(-1)[0]?.message);
      }
    },
    ...
    async fetchChannels() {
      ...
      try {
        ...
        console.error('Error fetching channels:', errorStore.getErrors().slice(-1)[0]?.message);
      }
    },
    ...
    async removeChannel(id: number) {
      ...
      try {
        ...
        console.error('Error removing channel:', errorStore.getErrors().slice(-1)[0]?.message);
      }
    },
    ...
    async fetchMessages() {
      ...
      try {
        ...
        console.error('Error fetching messages:', errorStore.getErrors().slice(-1)[0]?.message);
      }
    },
    ...
    async createMessage(message: Partial<Message>) {
      ...
      try {
        ...
        console.error('Error creating message:', errorStore.getErrors().slice(-1)[0]?.message);
      }
    },
    ...
    async updateMessage(message: Message) {
      ...
      try {
        ...
        console.error('Error updating message:', errorStore.getErrors().slice(-1)[0]?.message);
      }
    },
    ...
    async removeMessage(id: number) {
      ...
      try {
        ...
        console.error('Error removing message:', errorStore.getErrors().slice(-1)[0]?.message);
      }
    },
  },
});
