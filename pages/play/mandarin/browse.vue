<!-- /pages/play/mandarin/browse.vue
     The Mandarin catalog workspace: deck picker, search, gallery, free study, and
     requested words. This is m1-m4's surface, unchanged in behaviour.

     It moved here from /play/mandarin on 2026-09-20 (mandarin-tutor/t-028). Silas:
     "i want a real front end interface. We start, are given an introduction, then shown
     cards that give info, basically, a streamlined teaching interface." This page is a
     TOOL -- four workspace views, two interaction modes, a deck picker -- which is the
     right shape for someone who already knows what they want and the wrong shape for
     someone who wants to be taught. The guided course took over /play/mandarin as the
     front door; this stayed exactly as it was, one click away, for roaming, searching,
     custom decks, and free drilling.

     Nothing here was removed in that move. -->
<template>
