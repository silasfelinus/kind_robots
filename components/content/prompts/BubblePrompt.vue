<template>
  <div :style="blobStyle" class="blob cursor-pointer transition duration-300 hover:scale-105" @click="handleClick">
    {{ label }}
  </div>
</template>
...
function randomizeBlobShape(): string {
  const values = [
    `${getRandom(50, 60)}% ${getRandom(60, 70)}% ${getRandom(60, 70)}% ${getRandom(50, 60)}% / ${getRandom(
      50,
      60,
    )}% ${getRandom(50, 60)}% ${getRandom(50, 60)}% ${getRandom(50, 60)}%`,
    `${getRandom(60, 70)}% ${getRandom(50, 60)}% ${getRandom(50, 60)}% ${getRandom(60, 70)}% / ${getRandom(
      50,
      60,
