...
// Reactive binding to the current butterfly settings
const newButterflySettings = computed({
  get: () => butterflyStore.newButterflySettings,
  set: (value) => butterflyStore.updateButterflySettings(value),
})
</script>
