<template>
  <div
    class="bg-base-300 shadow-xl rounded-3xl border border-base-200 overflow-y-auto z-10 p-6 text-lg max-w-xl mx-auto transform transition-all duration-300 hover:scale-105"
  >
